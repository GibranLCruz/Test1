...
```{r}
enteros <- c(1,2 ,3 ,4 ,5 , 10 ,9 , 8, 7 ,6)
print(enteros)
```
...
```{r}
compClase <- c("Gael","Dani","Crisanta","Darwin","Angel","Pedro", "Alondra", "Armando", "Jose", "Alan")
print(compClase)
```
...
```{r}
resultado<- sqrt(2*pi)/max(c(3, 2, 4, 1, 8))
resultado
```
...
secuencia<-seq(0, log2(8), length = 20)
secuencia
```
